...
namespace exception
{
    namespace
    {
        ...
        void display_error_dialog()
        {
            ...
            show_mouse_cursor();
            MessageBoxA(nullptr, error_str.data(), "T6ZM-Client-Plugin ERROR", MB_ICONERROR);
        ...
        std::string generate_crash_info(const LPEXCEPTION_POINTERS exceptioninfo)
        {
            ...
            line("T6ZM-Client-Plugin Crash Dump");
            line("");
...
#pragma warning(pop)
        ...
        {
            const std::string crash_name = utils::string::va("minidumps/T6ZM-Client-Plugin-crash-%s.zip",
            ...
            zip_file.write(crash_name, "T6ZM-Client-Plugin Crash Dump");
        }
